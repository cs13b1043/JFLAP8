...
public class JFLAPEnvironmentOld extends JFrame implements
	...
	public JFLAPEnvironmentOld(Object model, int id) {
		this(ViewFactory.createView(model), id);
	}

	public JFLAPEnvironmentOld(File f, int id) {
	...
	public JFLAPEnvironmentOld(Component component, int id) {
		...
		this.revalidate();
		addSelectedComponentNew(component);
...
//			amDirty = true;
	...
	public void addSelectedComponentNew(Component component) {
		//TODO 
		this.add(component);
		this.revalidate();
		this.repaint();
